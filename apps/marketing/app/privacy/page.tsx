...
const sections = [
  ...
  { title: 'Your family\'s data, and our AI', body: 'The Hedge personalises learning to your family using only your family\'s own information: your Family Framework, your children\'s ages and interests, and the activities you have done. Your suggestions are built from your family, not from generic profiles. Your family\'s data and conversations are kept private to your account and stored in the EU. They are never sold, never used for advertising, and never used to train AI models. To generate ideas and answer your questions, The Hedge uses the Claude AI API from Anthropic. Anthropic does not use data sent through its API to train its models, and we only ever send the minimum needed to help you. We do not profile your family for advertising and we do not farm for engagement. You can export everything we hold about your family in a machine-readable format, or delete it entirely, at any time from your account settings or by emailing privacy@thehedge.ie.' },
